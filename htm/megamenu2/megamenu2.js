...
(function ($) {
    ...
    var methods = {
        ...
        init:function (options) {
            ...
            return this.each(function () {
                ...
                var megamenu2 = $(this),
                    menuItem = $(megamenu2).children('li'),
                ...
                if ("ontouchstart" in document.documentElement) {
                    ...
                    $(menuButton).hammer().on('tap', function () {
                        $(this).toggleClass('megamenu2_button_active');
                    ...
                    $(megamenu2).hammer().on('tap', function (event) {
                        event.stopPropagation();
                    });
                    $(window).bind('orientationchange', function () {
                        $(menuItemElement).addClass('noactive');
                        $(menuButton).removeClass('megamenu2_button_active');
                        $(menuDropDownElement).hide(0);
                        megamenu2DropDownPosition();
                    });
    ...
    $.fn.megamenu2Mobile = function (method) {
    ...
    function megamenu2DropDownPosition() {

        if ($(window).width() <= 768) {
            $('.megamenu2').children('li').hide(0);
            $('.megamenu2_button').show(0);
            $('.dropdown_flyout .levels').find('ul').css({'left':'0', 'top':'auto'}).show();
        }

        else {
            $('.megamenu2').children('li').show(0);
            $('.megamenu2_button').hide(0);
            $('.dropdown_flyout .levels').find('ul').css({'left':'96%', 'top':'-23px'}).hide();
            $('.megamenu2_vertical_right .dropdown_flyout .levels').find('ul').css({'left':'auto', 'right':'100%', 'top':'-23px'}).hide();
        }

        if ($(window).width() > 768 && $(window).width() > 1024) {
            $('.megamenu2_vertical_right .dropdown_flyout .levels').find('ul').css({'left':'96%', 'right':'auto', 'top':'-23px'}).hide();
        }
...
function megamenu2ContactForm() {
    
    
    $('#megamenu2_form #submit').click(function(){
        ...
        var data_string = $('#megamenu2_form').serialize();
        ...
        $.ajax({
            ...
            data: data_string,
            success: function() {
                $('#megamenu2_form').find('.error').hide(0);
                $('#megamenu2_form').before('<div class="sent"></div><br>');
