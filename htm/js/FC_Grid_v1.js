    ...
    setPriceProduct: function(product){
      ...
      if(parseFloat(product.priceNum) > 0 && oPositionPrice){
        ...
        if(product.priceNum!=product.priceOri){
           return oPositionPrice.innerHTML="<div style='font-size:18px; color:#a6a6a6'>de <strike>"+FCLib$.FormatPreco(FormatPrecoReais(product.priceOri))+"</strike></div><div style='font-size:20px; color:#b9519f'>por <font style='font-size:24px;font-weight:700;'>"+FCLib$.FormatPreco(FormatPrecoReais(product.priceNum))+"</font></div>" + oMaxInstallments + oEconomyJS;
         }
         else{
           return oPositionPrice.innerHTML="<div style='font-size:20px; color:#b9519f'>por <font style='font-size:24px;font-weight:700;'>"+FCLib$.FormatPreco(FormatPrecoReais(product.priceNum))+"</font></div>"+ oMaxInstallments;
         }
